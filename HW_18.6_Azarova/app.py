...
def convert(message: telebot.types.Message):
    insert_values = message.text.lower().split(' ')
    # принудительно понижаю регистр для ввода валюты с заглавной буквы
    ...
    try:
        ...
        amount = abs(float(amount))  # игнорируем минус, который ввел пользователь
